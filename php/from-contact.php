<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR !filter_var($email, FILTER_VALIDATE_EMAIL) OR empty($phone) OR empty($subject) OR empty($message) OR empty($city)) {
        ...
        $content .= "Ciudad: $city\n";
        $content .= "Asunto: $subjet\n";
        $content .= "Mensaje: $message\n";
        $content .= "Adjunto: $attached\n";
